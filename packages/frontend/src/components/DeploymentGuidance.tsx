    ...
    return (
      <div className="admin-setup-help">
        {deployment.backupRoots.length > 0 ? (
          <>
            <p>Configured backup folders (checked when you save):</p>
          ...
          <>
            ...
            <ol>
              ...
              <li>Set <code>LUDOCK_BACKUP_ROOTS=/backups</code> in Ludock’s <code>.env</code>, then run <code>docker compose up -d --force-recreate ludock</code> from its Compose folder to apply the mount and setting.</li>
      ...
      {deployment.composeRoots.length > 0 ? (
        ...
        <>
          ...
          <ol>
            ...
            <li>Set <code>LUDOCK_COMPOSE_ROOTS=/srv/game-stacks</code> in Ludock’s <code>.env</code>, then run <code>docker compose up -d --force-recreate ludock</code> from its Compose folder.</li>
